...
alias verigit2 "emback && v vsc && norcomt empty && v general && norcomt empty && v gi pseudo && norcomt empty && v codeforce && norcomt empty && v use && norcomt empty && v install && norcomt empty && v metrics && norcomt empty && v ttiimmo && norcomt empty"
