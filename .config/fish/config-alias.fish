...
# alias unhide "chflags nohidden ~/Music ~/Public ~/Movies ~/Pictures ~/Applications ~/Documents ~/Desktop ~/Downloads"
# alias hide "chflags hidden ~/Music ~/Public ~/Movies ~/Pictures ~/Applications ~/Documents ~/Desktop ~/Downloads" 
